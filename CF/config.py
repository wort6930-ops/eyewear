...
# Variable names match what the rest of the code expects; env vars differ from AWS version
...
AWS_REGION = 'us-east-1'  # dummy value, R2 ignores region
R2_ENDPOINT_URL = os.getenv('CF_R2_ENDPOINT_URL', '')
...
# R2 Paths (identical partition structure to AWS version)
